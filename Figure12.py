# -*- coding: utf-8 -*-
"""
Created on Thu Sep 21 15:13:10 2023

@author: Jay Sun
"""

#debug SRJST monitoring 
import csv
with open('thetair_sr.csv',encoding='gbk',errors='ignore') as total:
...
plt.plot(range(len(cl_listk)), cl_listk, color = 'k',\
         dashes=(5, 3), linewidth = 0.8, linestyle = '--',\
             label = 'Control Limit = 3.9201')
plt.legend()  
#%%
with open('thetaar_sr.csv',encoding='gbk',errors='ignore') as total:
    reader = csv.reader(total)
